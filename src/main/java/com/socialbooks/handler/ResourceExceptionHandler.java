...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<DetalheErro> handleAutorExistenteException(AutorExistenteException e,
			HttpServletRequest request) {
	...
	public ResponseEntity<DetalheErro> handleAutorNaoEncontradoException(AutorNaoEncontradoException e,
			HttpServletRequest request) {
